...
const QuestionCard = ({ data, 
  ...
  // normalize incoming data and handle different key names
  ...
  const getButtonStyle = (option) =>
    ...
    if (!showFeedback)
        {
        return "bg-indigo-700 hover:bg-indigo-600 hover:scal-[101]"
    }
    //Berlin
    //Berlin === Paris option is not equall to the answer
    //Paris === Paris option is S equall to the selected
  ...
  return (
    <div className="bg-gray-800 text-white p-6 rounded-2xl shadow-lg w-full 
    max-w-xl border border-gray-700">
        <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg-medium text-gray-300">
